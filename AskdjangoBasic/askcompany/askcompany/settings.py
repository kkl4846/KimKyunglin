...
SECRET_KEY = 'k4n%hqtvmkg)#&5j-tfb0*sa9lv5#^f!2)zac5*2(r#tctls$+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True  #이때 쿼리 실행내역을 메모리에 누적한다.
              #메모리가 부족할 수 있기때문에 서비스 진행시 꺼놓기?
ALLOWED_HOSTS = []
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            ],  #프로젝트 전반적으로 사용할 앱은 여기에 추가
        'APP_DIRS': True,  #거짓이라면 앱 밑에 있는 templates는 사용하지않음.
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'  #템플릿 태그 {%static "경로"%}에 의해서 참조됨
